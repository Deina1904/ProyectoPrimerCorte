...
<html lang="ES">
    ...
    <a class="navbar-brand" href="#">Registro Compañeros de equipo</a>
    ...
    <form method="post" > 
        <div class="jumbotron text-center" style="margin-bottom:0;margin-right: 50px;margin-left: 50px;margin-top: 25px;">
            ...
            <br>
            <input class="form-control" type="text" name="nombreEquipo" placeholder="&#128589 Nombre" required style="width: 50%;margin: auto;">
            <br>
            <label> N° Documento </label>
            <br>
            <input class="form-control"type="number" name="docEquipo" required style="width: 50%;margin: auto;">
            <br>
            <label> Super Poder </label>
            <br>
            <input class="form-control"type="text" name="poderCompañero" required style="width: 50%;margin: auto;">
            <br>
            <button class="btn btn-info" type="submit" name="registroEquipo"> Registrar Datos </button>
        </div>
            ...
            <?php 
                ...
                $sqlTabla2 = "INSERT into colegasequipo (idEquipo,Nombre,NoIdentificacion,Poder) 
                                                VALUES  ('','$nombre','$documento','$poder')";
                $ejecutar = mysqli_query($con,$sqlTabla2);
                    if($ejecutar == 1){
                        ...
                        <tbody>
                            <?php
                                $conexion=mysqli_connect("localhost","root","","trabajo1") or die (" hubo problemas");
                                    ...
                                    session_start();
                                $resu = mysqli_query($conexion , "SELECT * from colegasequipo");
                                    while ($consulta = mysqli_fetch_array($resu)) {
                            ?>
                            <tr>              
                                <td ><?php echo $consulta ['idEquipo']?></td>
                                <td ><?php echo $consulta ['Nombre']?></td>
                                <td ><?php echo $consulta ['NoIdentificacion']?></td>
                                <td ><?php echo $consulta ['Poder']?></td>

                                <td><a id="alink" href="f_mod_mis.php?id_m=<?php echo $consulta ['idEquipo'] ?>">Modificar</a></td> 
                                <td><a id="alink" href="eli_equipo.php?id_m=<?php echo $consulta ['idEquipo'] ?>">Eliminar</a></td> 
                            </tr>
                            <?php 
                            }
                            ?>
